export default {
  // Header
  "Welcome to": "환영합니다",
  "tryDemo": "간편한 전자건강보험 발급 서비스 데모 페이지입니다",
  "Play around": "새로운 세상을 만나보세요",
  "Get Started": "시작하기",
  "Sign Up": "FIDO 간편 가입",
  "Sign In": "FIDO 간편 로그인",
  "Use Mobile App": "모바일 앱에서 사용하세요",
  "Its Simple": "세상에서 가장 편한",
  "Issue Service": "전자건강보험증 발급 서비스",
  "getRegistration": "전자건강보험증 발급",
  "getRegistrationDescription": "입력한 정보를 간단히 검증하고, 전자건강보험증 발급",
  "Store it in the uport app": "앱에서 직접 관리",
  "Own your information": "DID 기술을 활용하여, 정보를 누구에게 보여줄건지 직접 관리합니다.",
  "Get access to city services": "병원에서 간편하게 사용",
  "Enjoy perks and benefits": "발급된 전자건강보험증을 간편하게 사용하세요.",
  "Ready? Lets do this": "발급받으러 가기",
  ...
  "The City of uPortlandia": "국민건강보험공단",
  "cityIdDisplayName": "전자건강보험증",
  "cityIdDescription": "간단한 클릭 몇 번으로 간편하게 전자건강보험증을 발급받을 수 있습니다.",
  "cityIdStep1": "앱으로 로그인",
  "cityIdStep2": "개인 정보 입력",
  "cityIdStep3": "개인 정보 검증",
  "cityIdStep4": "전자건강보험증 받기",
  ...
  "back": "뒤로가기",
  "Login with uPort": "앱에서 로그인하기",
  "will ask you to share": "에서 다음 정보를 요청합니다.",
  ...
  "regnLandingHeading": "간편 가입하고 전자건강보험증을 발급받으세요!",
  "regnLandingStep1": "종이 건강보험증은 이제 안녕.",
  "regnLandingStep2": "전자건강보험증으로 간편하게",
  "regnLandingStep3": "병원에서 간편하게 본인 확인",

  // Login
  "Open the uPort app to login": "Open the uPort app to login",
  "Continue": "Continue",
  "First things first": "앱에서 로그인하기",
  "To login scan the QR code with the uPort app": "로그인하시려면 앱에서 QR코드를 스캔하세요",
  "You're logging in to": "로그인 정보",
  "Tap to login with the uPort app": "Tap to login with the uPort app",
  "Don’t have the app? Download it from your store": "앱이 없으신가요? 스토어에서 다운로드하세요",
  "Issuer": "발급자",
  "No information requested": "추가 정보가 필요하지 않습니다.",
  "This information will be shared with": "으로 정보가 전송됩니다",
  "Waiting for login": "로그인 대기중",
  "Refresh": "새로고침",
  "Loading": "로딩중",
  "Requested information": "요청하는 정보",

  // Claims
  "regnFormHeading": "정보 입력",
  "regnFormLabel1": "정보를 입력해주세요.",
  "regnFormLabel2": "에서 확인합니다.",
  "* indicates required field": "* 필수입력",
  "This field is required": "필수입력 항목입니다",
  "agreeTnC": "<1>이용약관</1>에 동의합니다",
  "You must accept the terms and Conditions": "이용약관에 동의하셔야 합니다",
  "What's next?": "",
  "Your information will be verified": "",
  "Country": "국가",
  "Zip Code": "우편번호",
  "State or Province": "도시",
  "City": "구",
  ...
  "regnSuccessHeading2": "",
  "regnSuccessText1": "입력하신 정보가 확인되었습니다. 전자건강보험증 발급 준비가 완료 되었습니다.",
  "regnSuccessText2": "",
  "regnSuccessText3": "",
  "regnReceiveCTA": "전자건강보험증 다운로드",
  "Invalid date of birth": "생년월일을 정확하게 입력해주세요",
  "You must agree to the terms and conditions": "이용약관에 동의가 필요합니다",

  // Attestation
  "Scan this QR Code using the uPort App": "앱에서 QR코드를 스캔하세요",
  "Check your device": "앱을 확인하세요",
  "Not receiving the request?": "문제가 생기셨나요?",
  "No verified information to receive": "받을 수 있는 정보가 없습니다",
  "This information will be stored in your app": "이 정보는 앱에만 저장됩니다",
  "Subject": "발급 대상",
  "Issued Date": "발급 날짜",
  "Tap to open in a mobile browser": "모바일 브라우저에서 열려면 클릭하세요",
  "You're Interacting with": "다음 항목을 다운로드합니다",
  "Verified information you'll receive": "발급되는 정보",
  "Done": "완료",
